...
package com.android.lld.widget;
...
import com.android.lld.AllInOneActivity;
import com.android.lld.EventInfoActivity;
...
public class CalendarAppWidgetProvider extends AppWidgetProvider {
    ...
    static final String EXTRA_EVENT_IDS = "com.android.lld.EXTRA_EVENT_IDS";
    ...
    private void performUpdate(Context context,
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            launchCalendarIntent
                    .setData(Uri.parse("content://com.android.lld/time/" + millis));
    ...
    static Intent getLaunchFillInIntent(Context context, long id, long start, long end,
        ...
        String dataString = "content://com.android.lld/events";
        if (id != 0) {
